...
public class AudioRecorderButton extends Button {
	...
	public void clear() {
		...
		if (mDialogManager != null) mDialogManager.dimissDialog();
	...
	public AudioRecorderButton(Context context, AttributeSet attrs) {
		...
		String dir = Contents.TEMP_AUDIO_PATH; // "/storage/sdcard0/my_weixin";
		//String dir = Environment.getExternalStorageDirectory()+"/my_weixin";

		mAudioManager = AudioManager.getInstance(dir); // dir
